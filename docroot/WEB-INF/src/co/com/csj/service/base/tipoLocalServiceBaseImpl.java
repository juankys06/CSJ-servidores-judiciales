...
/**
 * The base implementation of the tipo local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link co.com.csj.service.impl.tipoLocalServiceImpl}.
 * </p>
 *
 * @author villartech
...
public abstract class tipoLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements tipoLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link co.com.csj.service.tipoLocalServiceUtil} to access the tipo local service.
	 */
	...
	public tipo addtipo(tipo tipo) throws SystemException {
		tipo.setNew(true);

		return tipoPersistence.update(tipo, false);
	}
	 ...
	 * @return the new tipo
	 */
	public tipo createtipo(long id) {
		return tipoPersistence.create(id);
	}
	...
	public tipo deletetipo(long id) throws PortalException, SystemException {
		return tipoPersistence.remove(id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public tipo deletetipo(tipo tipo) throws SystemException {
	...
	public tipo fetchtipo(long id) throws SystemException {
		return tipoPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public tipo gettipo(long id) throws PortalException, SystemException {
		return tipoPersistence.findByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<tipo> gettipos(int start, int end) throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int gettiposCount() throws SystemException {
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public tipo updatetipo(tipo tipo) throws SystemException {
		return updatetipo(tipo, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public tipo updatetipo(tipo tipo, boolean merge) throws SystemException {
		tipo.setNew(false);

		return tipoPersistence.update(tipo, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("co.com.csj.model.tipo",
			tipoLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"co.com.csj.model.tipo");
	}
	...
	private tipoLocalServiceClpInvoker _clpInvoker = new tipoLocalServiceClpInvoker();
}