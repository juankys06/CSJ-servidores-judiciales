...
public class Conexion {
	...
	public static String DATA_SOURCE_PRINCIPAL = "java:comp/env/jdbc/despachos-judiciales"; 
	public static String DATA_SOURCE_APP = "java:comp/env/jdbc/base_datos_csj" ;
	public static String DATA_SOURCE_PORTAL = "java:comp/env/jdbc/csjDB" ;
    ...
    public boolean cerrarConexion() {
        try {
            ...
            System.err.println("Error con la secuencia SQL al cerrar la conexión");
        }
        return true;
    }
