...
<portlet:actionURL name="buscar_usuario" var="buscar_usuario"></portlet:actionURL>
	...
	<div class="container">
		 <div class="row"> 
			<div class="col-lg-12 col-md-12 col-xs-12 text-center">
				<h1>Ingrese Número de Documento del Solicitante del Permiso</h1>
			</div>
		<!-- </div> -->
		<!-- <div class="row"> -->
			
				<form action="<%= buscar_usuario%>" id="buscar_usuario" name="buscar_usuario" method="post">
